...
OBJS = v1718_lib.o vme_bridge.o V1742_lib.o V1751_lib.o X742CorrectionRoutines.o

OBJS_CAENCOMM = X742CorrectionRoutines.o V1742_lib.o V1751_lib.o 
...
acquire: $(OBJS) main_acquisition.o 
	g++ -g -DLINUX -o acquire $(OBJS) -lncurses -lm -lCAENVME  -lCAENComm -lCAENDigitizer main_acquisition.o -L/usr/local/hdf5/lib -lhdf5 -lhdf5_cpp
...
V1751_lib.o: V1751_lib.c V1751_lib.h
	g++ $(COPTS) -c  V1751_lib.c
